...
bool slam_toolbox__msg__graph_edge__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("slam_toolbox.msg._graph_edge.GraphEdge", full_classname_dest, 38) == 0);
  }
  slam_toolbox__msg__GraphEdge * ros_message = _ros_message;
  {  // source_id
    ...
    ros_message->source_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // target_id
...
PyObject * slam_toolbox__msg__graph_edge__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("slam_toolbox.msg._graph_edge");
  ...
  slam_toolbox__msg__GraphEdge * ros_message = (slam_toolbox__msg__GraphEdge *)raw_ros_message;
  {  // source_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->source_id);
    {
