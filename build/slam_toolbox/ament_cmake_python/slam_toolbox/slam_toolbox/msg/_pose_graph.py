...
class Metaclass_PoseGraph(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from slam_toolbox.msg import GraphNode
...
class PoseGraph(metaclass=Metaclass_PoseGraph):
    ...
    _fields_and_field_types = {
        ...
        'nodes': 'sequence<slam_toolbox/GraphNode>',
        'edges': 'sequence<slam_toolbox/GraphEdge>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'msg'], 'GraphNode')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['slam_toolbox', 'msg'], 'GraphEdge')),  # noqa: E501
    )
