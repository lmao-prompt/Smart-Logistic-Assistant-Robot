...
bool slam_toolbox__msg__graph_node__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("slam_toolbox.msg._graph_node.GraphNode", full_classname_dest, 38) == 0);
  }
  slam_toolbox__msg__GraphNode * ros_message = _ros_message;
  {  // node_id
...
PyObject * slam_toolbox__msg__graph_node__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("slam_toolbox.msg._graph_node");
  ...
  slam_toolbox__msg__GraphNode * ros_message = (slam_toolbox__msg__GraphNode *)raw_ros_message;
  {  // node_id
    PyObject * field = NULL;
