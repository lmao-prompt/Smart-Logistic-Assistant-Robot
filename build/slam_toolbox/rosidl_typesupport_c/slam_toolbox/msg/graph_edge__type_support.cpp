...
#include "slam_toolbox/msg/detail/graph_edge__type_support.h"
...
static const _GraphEdge_type_support_symbol_names_t _GraphEdge_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, msg, GraphEdge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_toolbox, msg, GraphEdge)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_toolbox, msg, GraphEdge)() {
  return &::slam_toolbox::msg::rosidl_typesupport_c::GraphEdge_message_type_support_handle;
}
