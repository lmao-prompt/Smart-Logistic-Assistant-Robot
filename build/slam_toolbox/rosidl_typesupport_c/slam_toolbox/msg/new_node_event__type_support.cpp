...
#include "slam_toolbox/msg/detail/new_node_event__type_support.h"
...
static const _NewNodeEvent_type_support_symbol_names_t _NewNodeEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_toolbox, msg, NewNodeEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_toolbox, msg, NewNodeEvent)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_toolbox, msg, NewNodeEvent)() {
  return &::slam_toolbox::msg::rosidl_typesupport_c::NewNodeEvent_message_type_support_handle;
}
