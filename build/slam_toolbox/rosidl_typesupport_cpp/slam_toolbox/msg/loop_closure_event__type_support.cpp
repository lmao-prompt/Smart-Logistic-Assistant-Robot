...
static const _LoopClosureEvent_type_support_symbol_names_t _LoopClosureEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, slam_toolbox, msg, LoopClosureEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, slam_toolbox, msg, LoopClosureEvent)),
  }
};
...
{
  return &::slam_toolbox::msg::rosidl_typesupport_cpp::LoopClosureEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, slam_toolbox, msg, LoopClosureEvent)() {
  return get_message_type_support_handle<slam_toolbox::msg::LoopClosureEvent>();
}
