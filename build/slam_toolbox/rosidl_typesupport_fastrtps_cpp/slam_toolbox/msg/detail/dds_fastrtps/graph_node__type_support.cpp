...
#include "slam_toolbox/msg/detail/graph_node__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const slam_toolbox::msg::GraphNode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  slam_toolbox::msg::GraphNode & ros_message)
{
  // Member: node_id
  cdr >> ros_message.node_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = slam_toolbox::msg::GraphNode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const slam_toolbox::msg::GraphNode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<slam_toolbox::msg::GraphNode *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GraphNode__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const slam_toolbox::msg::GraphNode *>(
...
static size_t _GraphNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GraphNode(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GraphNode__callbacks = {
  "slam_toolbox::msg",
  "GraphNode",
...
static rosidl_message_type_support_t _GraphNode__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GraphNode__callbacks,
...
{
  return &slam_toolbox::msg::typesupport_fastrtps_cpp::_GraphNode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, slam_toolbox, msg, GraphNode)() {
  return &slam_toolbox::msg::typesupport_fastrtps_cpp::_GraphNode__handle;
}
