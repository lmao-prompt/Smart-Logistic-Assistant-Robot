...
#ifndef SLAM_TOOLBOX__MSG__DETAIL__LOOP_CLOSURE_EVENT__TYPE_SUPPORT_H_
#define SLAM_TOOLBOX__MSG__DETAIL__LOOP_CLOSURE_EVENT__TYPE_SUPPORT_H_
...
#endif  // SLAM_TOOLBOX__MSG__DETAIL__LOOP_CLOSURE_EVENT__TYPE_SUPPORT_H_
